...
const kadın = message.guild.roles.cache.find(r => r.id === '800447507280822293')
const kadın2 = message.guild.roles.cache.find(r => r.id === '800462434250522664')
const kadın3 = message.guild.roles.cache.find(r => r.id === '800462468375642122')
...
if(!kadın) return message.channel.send('1.ci Kız rolü ayarlanmamış.')
if(!kadın2) return message.channel.send('2.ci Kız rolü ayarlanmamış.')
if(!kadın3) return message.channel.send('3.ci Kız rolü ayarlanmamış.')
...
• ${kadın}, ${kadın2}, ${kadın3} Rolleri Verildi.
...
.addField(`Roller`, `${kadın}, ${kadın2}, ${kadın3}`, true)
