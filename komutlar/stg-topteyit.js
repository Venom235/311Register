...
if(!message.member.roles.cache.some(r => ['800447499768430613', '800447477203206176'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
